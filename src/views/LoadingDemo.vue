...
<template>
  <div class="space-y-5">
    ...
    <div class="flex items-center space-x-5">
      <Loading :thickness="4" />
      <Loading :thickness="15" />
      <Loading type="error" class="h-15 w-15" />
      <Loading>
        <template #icon>
          <div class="i-eos-icons:bubble-loading h-8 w-8 text-blue-500" />
        </template>
      </Loading>
      <Loading>
        <template #icon>
          <div class="i-eos-icons:three-dots-loading h-10 w-10 text-green-500" />
        </template>
      </Loading>
