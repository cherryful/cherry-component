  ...
  <div>
    ...
    <form class="mt-10" @submit.prevent="submit">
      ...
      <div class="flex flex-col justify-center gap-2 mt-2">
        <div>
          <div v-if="stepper.isCurrent('user-information')" class="w-70">
            <Input v-model:value="form.firstName" placeholder="enter your name" />
          </div>

          <div v-if="stepper.isCurrent('terms')">
            <div>
              <Checkbox id="contract" v-model:value="form.contractAccepted" class="mr-2">
